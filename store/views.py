...
from .permissions import IsAdminOrReadOnly, FullDjangoModelPermissions, ViewCustomerHistoryPermissins
...
class CustomerViewSet(ModelViewSet):
    ...
    @action(detail=True, permission_classes=[ViewCustomerHistoryPermissins])
